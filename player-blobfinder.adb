...
package body Player.Blobfinder is
   ...
   is
      function C_Create (Conn : in Types.Handle; Index : in C.int)
                         return Types.Handle;
      pragma Import (C, C_Create, "playerc_blobfinder_create");
   begin
   ...
   procedure Subscribe (This : in out Object; Mode : in Access_Modes) is
      function C_Subscribe (This : in Types.Handle; Mode : in Access_Modes)
                            return C.int;
      pragma Import (C, C_Subscribe, "playerc_blobfinder_subscribe");
   begin
   ...
   procedure Unsubscribe (This : in out Object) is
      ...
      pragma Import (C, C_Unsubscribe, "playerc_blobfinder_unsubscribe");
   begin
